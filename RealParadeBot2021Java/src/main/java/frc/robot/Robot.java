...
public class Robot extends TimedRobot {
  ...
  private WPI_TalonSRX driveMotorRight = new WPI_TalonSRX(3);
  
  private WPI_TalonSRX driveMotorLeft1 = new WPI_TalonSRX(2);
 // private WPI_TalonSRX driveMotorLeft2 = new WPI_TalonSRX(3);

  private WPI_TalonSRX driveMotorRight1 = new WPI_TalonSRX(4);
  //private WPI_TalonSRX driveMotorRight2 = new WPI_TalonSRX(6);

  private SpeedControllerGroup leftgroup = new SpeedControllerGroup(driveMotorLeft, driveMotorLeft1);
